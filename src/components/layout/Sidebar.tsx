...
export function Sidebar() {
    ...
    return (
        <aside className="w-64 h-screen bg-[#F5F2ED] flex flex-col border-r border-gray-200 fixed left-0 top-0 z-50">
            {/* Profile Section */}
            <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="font-bold text-gray-800">{adminProfile?.name || "Admin"}</p>
